...
public class Constants {
    ...
    public static final String SAVED_INSTANCE_RECIPE_STEPS_POSITION_STATE   = "SAVED_INSTANCE_RECIPE_STEPS_POSITION_STATE";
    public static final String SAVED_INSTANCE_RECIPE_STEPS_STATE    = "SAVED_INSTANCE_RECIPE_STEPS_STATE";
    public static final String SAVED_INSTANCE_ITEM_SELECTED         = "SAVED_INSTANCE_ITEM_SELECTED";
